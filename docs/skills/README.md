# Camp Operational Skills

This directory is the canonical, repository-local operational reference for agents and maintainers. Update the narrowest existing guide when code, tests, a reproducible command, an observed failure, or authoritative upstream behavior establishes durable knowledge.
